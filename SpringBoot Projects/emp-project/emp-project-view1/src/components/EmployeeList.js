  ...
  return (
    <div className="container mx-auto my-8">
        <div>
          ...
          className="bg-slate-600 hover:bg-blue-700 my-1 font-semibold px-20 py-2 rounded"> Add Employee 👨🏼‍💻</button>
        </div>
            ...
            <table className="shadow">
                ...
                <tbody>
                    ...
                    <tr className="hover:bg-white hover:text-black">
                        ...
                        <td className="text-left px-6 py-4 whitespace-nowrap">{employee.phoneNo}</td>
                        ...
                        className='hover:text-red-500 hover:cursor-pointer'> Delete 🗑️</a>
                        </td>
                    </tr>
                    )}
                </tbody>
